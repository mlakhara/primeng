...
export class TableScrollDemo implements OnInit {
    ...
    loadDataOnScroll(event: LazyLoadEvent) {
        ...
        setTimeout(() => {
            // this.virtualCars =  [{"brand": "VW", "year": 2012, "color": "Orange", "vin": 0},
            // {"brand": "Audi", "year": 2011, "color": "Black", "vin": 0 + 1},
            // {"brand": "Renault", "year": 2005, "color": "Gray", "vin": 0 + 2},
            // {"brand": "BMW", "year": 2003, "color": "Blue", "vin": 0 + 3},
            // {"brand": "Mercedes", "year": 1995, "color": "Orange", "vin": 0 + 4},
            // {"brand": "Volvo", "year": 2005, "color": "Black", "vin": 0 + 5}];
            this.virtualCars = [
